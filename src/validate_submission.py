...
def main():
    parser = argparse.ArgumentParser(description="Validate ML Challenge 2026 submission output files.")
    ...
    parser.add_argument("--test-dir", "-t", default="dataset/test", help="Folder with test_source1.tsv")
    parser.add_argument("--check-ids", action="store_true", help="Check matched IDs existence")
